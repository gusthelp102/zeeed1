...
class _ProductSearchWidgetState extends State<ProductSearchWidget>
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<MerchRecord>>(
      future: MerchRecord.search(
      ...
      builder: (context, snapshot) {
        ...
        List<MerchRecord> productSearchMerchRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                ...
                children: [
                  ...
                  StreamBuilder<List<MerchRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<MerchRecord> listViewMerchRecordList =
                          snapshot.data!;
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    16.0, 2.0, 0.0, 0.0),
                                            child: Text(
                                              listViewMerchRecord.description!,
                                              style:
